...
class AdditionalTickets extends EventShow {
  ...
  constructor(orderParams) {
    ...
    this.ticket_preferential_price = orderParams.ticket_preferential_price;
    this.ticket_preferential_quantity = orderParams.ticket_preferential_quantity;
    this.ticket_group_price = orderParams.ticket_group_price;
    this.ticket_group_quantity = orderParams.ticket_group_quantity;
  }
}